...
public class showdays {
    ...
    public static void main(String[] args) {
        ...
        // Ask for the user input until valid input is provided
        while (true) {
    ...
    // Method to map the user input to a valid month number
    ...
    // Method to calculate the number of days in a given month and year
